...
<body>
    <div class="container">
        ...
        <div class="body">
            ...
            <p>Hola {{ $quotation->name }},</p>
            <p>
                Gracias por completar nuestro formulario. Hemos recibido tu pedido de cotización sobre los siguientes servicios:
                <ul>
                @foreach ($quotation->tags as $tag)
                    <li>{{ $tag }}</li>
                @endforeach
                </ul>
                Nos pondremos en contacto contigo a la brevedad. Si tienes alguna pregunta mientras tanto, no dudes en responder a este correo.
            </p>
        ...
        <div class="footer">
            ...
            <p>Email: <a href="mailto:info@chimicreativo.es">info@chimicreativo.es</a></p>
        </div>
    </div>
</body>
</html>
